...
from ..deterministic.utils import (
...
def compute_trace_dataset_hash(traces_root: Path, manifest_path: Optional[Path] = None) -> str:
    ...
    """
    return compute_trace_dataset_hash_from_manifest(traces_root, manifest_path)
...
def run_variants(args) -> int:
    ...
    evals_root = Path(__file__).resolve().parents[2]  # variants -> src -> evals
