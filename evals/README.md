...
| Raw case JSON | ❌ No | Downloaded at runtime from MAC |
| Run outputs | ❌ No | Regenerated by reviewers (Phase 3+) |
| Metrics | ❌ No | Regenerated by reviewers (Phase 4+) |
...
```
evals/data/cases/*.json          # Raw MAC case files
