...
def build_cdss_graph(exaim: EXAIM):
    ...
    laboratory = LaboratoryAgent(exaid=exaim)
    cardiology = CardiologyAgent(exaid=exaim)
    internal_medicine = InternalMedicineAgent(exaid=exaim)
    radiology = RadiologyAgent(exaid=exaim)
