...
To provide a holistic view of system behavior, we report five additional metrics in Table~\ref{tab:supplementary-metrics}. These include \textbf{Update Frequency (M1)} and \textbf{Token Volume (M2)}, which provide context for the coverage scores; \textbf{Window-Groundedness (M7)}; and \textbf{Budget-Constrained Coverage (M5)}, which offers granular insights into token economics.

\subsubsection{Limitations of Concept-Level Faithfulness Metrics in Compressed Clinical Summaries}

Our faithfulness metrics (M7, M6) operate at the level of explicit concept realization rather than semantic equivalence or entailment. This design choice introduces a fundamental structural mismatch between what summarization accomplishes and what strict concept-overlap metrics measure.
...
\midrule
Faithfulness (M6) & 0.421 & 0.333 & 0.409 & 0.382 & 0.424 \\
...
Window-Groundedness (M7) & 0.825 & 0.787 & 0.879 & 0.823 & 0.845 \\
Coverage @ 2000 CTU (M5) & 0.160 & 0.144 & 0.207 & 0.132 & 0.166 \\
